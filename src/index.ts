import { handleDecrementMode, handleIncrementMode, handleDecrementLength, handleIncrementLength, toggleSolfa } from "./ts/state.js";
import { handleClickPlay } from "./ts/audio.js";
import { drawStaff } from "./ts/cantusScore.js";
...
randomiseButton.addEventListener("click", () => { drawStaff(true) });
